...
def newton_raphson():
    ...
    elección = input("Ingrese el número de la función: ")
    ...
    if elección == "6":
        ...
        try:
            ...
            return
    elif elección in funciones:
        f = funciones[elección]
    else:
    ...
    f_derivada_leiblexd = sp.lambdify(x, f_derivada, 'math')
